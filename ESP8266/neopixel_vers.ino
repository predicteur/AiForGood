...
///////////////////////////////////////////////////////////////////
const char* device_name = "JeanClaude";                                        // Set your device name !!!!!
///////////////////////////////////////////////////////////////////
...
if ( (millis() - temps_ref) >= 15000 )
{
  ...
  if (req == "/BIEN") {
     sensorVal1 = 1; sensorVal2 = 0; sensorVal3 = 0;    
  }
  else if (req == "/NORMAL") {
    sensorVal1 = 0; sensorVal2 = 1; sensorVal3 = 0; 
  }
  else if (req == "/PASBIEN") {
    sensorVal1 = 0; sensorVal2 = 0; sensorVal3 = 1 ;   
  }
